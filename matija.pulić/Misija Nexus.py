...
plt.hexbin(
    df_cisto["Temp_Tla_C"],
    df_cisto["H2O_Postotak"],
    gridsize=30,
    cmap="plasma"
)

plt.colorbar(label="Gustoća točaka")
...
sns.kdeplot(
    data=df_cisto[df_cisto["Metan_Senzor"] == "Pozitivno"],
    x="GPS_LONG",
    y="GPS_LAT",
    cmap="Reds",
    fill=True,
...
sns.scatterplot(
    ...
    y="GPS_LAT",
    hue="Metan_Senzor",
    palette={"Pozitivno": "red", "Negativno": "white"},
    alpha=0.6,
    s=15
)
